...
import { vmeBoekjaarOverzicht } from "@/lib/vme-dashboard";
...
export default async function DashboardPage() {
  ...
  const [overzicht, controle, huurders] = await Promise.all([
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-xl font-semibold">{vme.naam}</h1>
      ...
      <div className="grid gap-4 md:grid-cols-2">
        <Card>
          <CardHeader>
            <CardTitle className="text-base">Opbrengsten</CardTitle>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="text-base">Uitgaven</CardTitle>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-base">Bankrekeningen</CardTitle>
          <CardDescription>
